 ...
 * @Description : Exception Error 처리 페이지
 * @Version     : 3.0.0
...
<%
// Request Parameters
String errorCode = StringUtil.xss(request.getAttribute("errorCode"));
String errorHeading = StringUtil.clean(request.getAttribute("errorHeading"), "일시적인 시스템 장애 입니다!!");
String returnUrl = StringUtil.xss(request.getAttribute("returnUrl"));
if (!StringUtil.isBlank(errorCode)) {
	if ("system.error".equals(errorCode)) {
		errorHeading = "일시적인 시스템 장애 입니다!!";
	}
}
%>
...
<body>
	<div id="dialogWrapper">
		<div id="errorWrapper" class="error">
			<h1 class="small"><%=errorHeading%></h1>
			<div id="message">
				<p class="intro">
