 ...
 * @File Name   : error.jsp
 * @Description : Default Error 처리 페이지
 * @Version     : 3.0.0
...
<body>
	<% if (!isPrintErrorMessage) { %>
		<div id="errorWrapper" class="error">
			<h1>일시적인 시스템 장애 입니다!!</h1>
			<div id="message">
				<p class="intro">사용중 불편을 드려서 대단히 죄송합니다.</p>
				<p>
					잠시후에 다시한번 시도해 주시길 바랍니다.<br />
					계속해서 시스템 장애를 일으킬 경우 관리자에게 문의해 주세요!!
				</p>
	...
	<% } else { %>
		<div id="errorReport">
			<table>
				...
				<thead>
					<tr>
						<th colspan="2" scope="colgroup">HTTP Status Error - Exception Report!!</th>
					</tr>
				</thead>
				<tbody>
					<tr>
